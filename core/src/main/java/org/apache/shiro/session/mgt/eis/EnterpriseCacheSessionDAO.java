...
/**
 * SessionDAO实现依赖于企业缓存产品作为所有会话的EIS记录系统。
 * 预期注入的{@link org.apache.shiro.cache.Cache Cache}或{@link org.apache.shiro.cache.CacheManager CacheManager}由可支持所有应用程序会话和
 * 或提供所有功能的企业缓存产品支持磁盘分页，用于弹性数据存储。
 *
