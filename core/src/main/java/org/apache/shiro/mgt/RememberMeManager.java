...
/**
 *  记住我 管理器   RememberMeManager负责在主题与应用程序的会话之间记住主题的身份。
...
public interface RememberMeManager {
    ...
    /**
     *
     *  忘记与用于构建主题实例的主题上下文映射相对应的所有记住的身份。
     *
    ...
    /**
     *
     * 对成功的身份验证尝试做出反应，通常会保存要检索（“记住”）的主体以供将来系统访问。
     *
    ...
    /**
     *
     *  登录失败  对失败的身份验证尝试做出反应，通常是通过忘记任何先前记住的主题主体。
     *
    ...
    /**
     *
     *  对退出应用程序的主题做出反应，通常是通过忘记该主题以前记住的任何主体。
     *
