 ...
 * TODO 待理解
 *
 *  BearerToken 的  Authorization  Header 存放这个值
 *
 * 包含承载令牌或API密钥的AuthenticationToken ，通常通过HTTP Authorization 标头接收。
 * 此类还实现了HostAuthenticationToken接口，以保留进行身份验证尝试的主机名或IP地址位置。
 *
