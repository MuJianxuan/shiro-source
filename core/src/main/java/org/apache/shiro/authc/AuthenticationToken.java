...
public interface AuthenticationToken extends Serializable {
     ...
     * 返回在身份验证过程中提交的帐户标识。
     *
     * 大多数应用程序身份验证均基于用户名/密码，并且该对象代表用户名。
     * 如果您的应用程序是这种情况，请查看UsernamePasswordToken ，因为它可能足以供您使用。
     *
     * 最终，返回的对象是特定于应用程序的，并且可以表示任何帐户标识（用户ID，X.509证书等）。
     *
     *
    ...
    /**
     *
     * 返回用户在验证过程中提交的凭据，以验证提交的account identity 。
     *
     * 大多数应用程序身份验证均基于用户名/密码，并且该对象表示提交的密码。
     * 如果您的应用程序是这种情况，请查看UsernamePasswordToken ，因为它可能足以供您使用。
     *
     * 最终，返回的凭证对象是特定于应用程序的，并且可以表示任何凭证机制
     *
