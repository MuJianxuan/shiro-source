...
/**
 *
 *  Account}接口的简单实现，该接口包含主体，凭证和授权信息（角色和权限）作为实例变量，
 *  并使用标准JavaBean表示法通过getter和setter公开它们。
 *
 *   实现 了 账户信息接口 、 角色权限信息接口
 *
 *
...
public class SimpleAccount implements Account, MergableAuthenticationInfo, SaltedAuthenticationInfo, Serializable {
    ...
    /**
     *
     *  表示该帐户已被锁定。不是所有的<tt> Realms <tt>都尊重这一点，但是
     *
    ...
    /**
     *
     *  使用给定的主体和凭证为指定领域构造一个SimpleAccount实例。
     *
